...
Public Class LibXRunner
    ...
    Public Shared Sub Run(ByVal fullPrgName As String, ByVal mdl As String)
        Try
            Run(fullPrgName, "", mdl, False)
    ...
    Public Shared Sub Run(ByVal fullPrgName As String, ByVal mdl As String, ByVal modal As Boolean)
        Try

            Run(fullPrgName, "", mdl, modal)
    ...
    Public Shared Sub Run(ByVal fullPrgName As String, ByVal typeName As String, ByVal mdl As String)
        Try

            Run(fullPrgName, typeName, mdl, False)
    ...
    Public Shared Sub Run(ByVal fullPrgName As String, ByVal typeName As String, ByVal mdl As String, ByVal modal As Boolean)
        Try
            If Trim(mPath) = "" Then
                Dim s As String
                Dim sh As String
    ...
    Public Shared Sub RunWithPath(ByVal fullPrgName As String)
        Try
            RunWithPath(fullPrgName, "", False)
    ...
    Public Shared Sub RunWithPath(ByVal fullPrgName As String, ByVal modal As Boolean)
        Try

            RunWithPath(fullPrgName, "", modal)
    ...
    Public Shared Sub RunWithPath(ByVal fullPrgName As String, ByVal typeName As String)
        Try

            RunWithPath(fullPrgName, typeName, False)
    ...
    Public Shared Sub RunWithPath(ByVal fullPrgName As String, ByVal typeName As String, ByVal modal As Boolean)
        Try
            ...
            If User.UserID > 0 Then
                ...
                Permission.ProgramName = typeName

                '// Asignar Permisos
                If Permission.Load() = True Then
                    For Each oc As Object In ob.controls
                        If TypeOf oc Is LibXNavigator Then
                            Dim libxc As LibXConnector = CType(oc.Connector, LibXConnector)
                            With LibX.App.CurrentPrgParams
                                libxc.AllowDelete = Permission.AllowDelete
                                libxc.AllowEdit = Permission.AllowEdit
                                libxc.AllowNew = Permission.AllowAdd
                                libxc.AllowPrint = Permission.AllowPrint
                                libxc.AllowQuery = Permission.AllowQuery
                            End With
                        End If
                    Next
                End If
