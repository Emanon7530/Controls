...
Public Class XDataGridNotFocusColumn
    ...
    '    'If Not grid Is Nothing And rowNum = grid.CurrentRowIndex Then
    '    '    colNum = DataGridTableStyle.GridColumnStyles.IndexOf(Me)
    '    '    If (grid.CurrentCell.ColumnNumber = colNum) Then
    '    '        backBrush = Brushes.LightBlue ' //color the disabled cell
    '    '    End If
    '    'End If
    '    MyBase.Paint(g, bounds, source, rowNum, backBrush, foreBrush, alignToRight)
