...
#End Region
    ...
    Protected Overrides Sub OnBindingContextChanged(ByVal e As System.EventArgs)
        ...
        If Not mCon Is Nothing Then
            If Me.mRequiered Then
                mCon.AddRequired(Me)
            End If
            _BindingObject = Me.DataBindings(0)
        End If
    ...
    Private Sub XTextBox_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyUp
    ...
    Private Sub XTextBox_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
        If e.KeyChar = Chr(13) Then
            e.Handled = True
            Exit Sub
        End If
        'e.Handled = CkKeyPressNumeric(Asc(Val(e.KeyChar)), Me) = 0
    ...
    Private Sub _BindingObject_Format(ByVal sender As Object, ByVal e As System.Windows.Forms.ConvertEventArgs) Handles _BindingObject.Format
        If e.Value.ToString.Trim = "" Then
            e.Value = DBNull.Value
            Return
        End If
